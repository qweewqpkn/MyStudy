...
namespace UnityEngine.UI
{
    ...
    public abstract class LoopScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        private static GameObject LoopScrollRectRootGO
        {
            get
            {
                if(mLoopScrollRectRootGO == null)
                {
                    mLoopScrollRectRootGO = new GameObject("LoopScrollRect");
                }

                return mLoopScrollRectRootGO;
            }
        }
        ...
        private void OnNofityElement(Transform trans, int index)
        {
            if(trans == null || mNotifyElement == null)
            {
                return;
            }

            UIComponentBind bind = trans.GetComponent<UIComponentBind>();
            if (bind != null)
            {
                mNotifyElement(bind.CompentsTable, index);
            }
        }
