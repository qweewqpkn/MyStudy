	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				reflectDir = normalize(reflectDir + float3(0, 0 , -1)) * 0.5 + 0.5;
				fixed3 reflectColor = (specular + tex2D(_ReflectTex, reflectDir.xy).rgb) * _ReflectStrength;
