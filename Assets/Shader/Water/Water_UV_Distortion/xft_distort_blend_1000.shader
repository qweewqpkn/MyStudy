...
Shader "Custom/distort_blend_1000" {
Properties {
...
Category {
	...
	Blend SrcAlpha  One// SrcAlpha DstColor DstAlpha OneMinusSrcAlpha One OneMinusDstAlpha  Zero
	Cull Off 
	//ZTest Always
...
fixed4 frag( v2f i ) : COLOR
{
	...
	return 2 * i.color * _TintColor * tex2D( _MainTex, i.uvmain);
}
ENDCG
		}
}
