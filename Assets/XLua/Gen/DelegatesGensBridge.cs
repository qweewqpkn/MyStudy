...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp4(int p0, int p1, out TestLua.DClass p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                p2 = (TestLua.DClass)translator.GetObject(L, errFunc + 2, typeof(TestLua.DClass));
		...
		public XLuaTest.InvokeLua.ICalc __Gen_Delegate_Imp5(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Collections.IEnumerator __Gen_Delegate_Imp37(object p0, object p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(TestLua.ShowStr))
			{
			    return new TestLua.ShowStr(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(XLuaTest.InvokeLua.CalcNew))
			{
			    return new XLuaTest.InvokeLua.CalcNew(__Gen_Delegate_Imp5);
			}
